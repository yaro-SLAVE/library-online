      ...
      <div class="order-details">
        ...
        <div v-else>
          ...
          <div class="section">
            ...
            <div
              v-if="Array.isArray(order.statuses) && order.statuses.length > 0"
              class="status-timeline"
            >
              <div v-for="(st, idx) in order.statuses" :key="st.date ?? idx" class="status-item">
              ...
              <div v-for="bookItem in order.books" :key="bookItem.id" class="book-item">
                <div class="book-main-info">
                  ...
                  <div class="book-authors">
                    {{
                      bookItem.book?.author && bookItem.book.author.length
                        ? bookItem.book.author.join(", ")
                        : "Автор не указан"
                    }}
                  </div>
