...
from library_service.views.order import BorrowedViewset, OrderViewset, ExternalOrderViewset
...
router.register("external", ExternalOrderViewset, basename="external")
